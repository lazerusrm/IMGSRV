...
main() {
    ...
    echo "Next steps:"
    echo ""
    echo "1. Configure DNS for SSL certificate:"
    echo "   Add A record in GoDaddy for industrialcamera.com:"
    echo "     Type: A"
    ...
    echo ""
    echo "3. Add SSH public key to: /home/$SERVICE_USER/.ssh/authorized_keys"
    echo ""
    echo "4. Configure VPS settings on your camera server:"
    echo "   VPS_ENABLED=true"
    echo "   VPS_HOST=$(hostname -I | awk '{print $1}')"
    echo "   VPS_USER=$SERVICE_USER"
    echo ""
    echo "5. Test the setup: curl http://$(hostname -I | awk '{print $1}')/health"
    echo ""
